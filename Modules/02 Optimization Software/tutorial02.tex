...
\begin{enumerate}
    ...
    \item Your requested license will immediately appear in your account.
        You can access your current licenses by hovering over \raisebox{-.25\height}{\includegraphics[height=0.8\baselineskip]{GurobiAccountIcon.png}}, selecting \textbf{My Account}, then clicking on \textbf{Review Your Current Licenses} under \textbf{My Licenses}.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Select CPLEX through the store by clicking \menu{Home Page} and navigating to \menu{Students > Data \& Analytics > Software > CPLEX} (this can be a bit tricky). 
        Click \menu{Add to Cart}, then click \menu{Check Out}.
